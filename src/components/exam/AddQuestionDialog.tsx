          ...
          <div className="flex gap-1 p-1 bg-zinc-100 rounded-xl">
            <button
              ...
              className={`flex-1 py-1.5 text-xs font-medium rounded-lg transition-all ${
                mode === "single" ? "bg-white text-amber-700 shadow-sm" : "text-zinc-500 hover:text-zinc-700"
              }`}
            >
              单题添加
            </button>
            <button
              ...
              className={`flex-1 py-1.5 text-xs font-medium rounded-lg transition-all ${
                mode === "batch" ? "bg-white text-amber-700 shadow-sm" : "text-zinc-500 hover:text-zinc-700"
              }`}
            >
              批量粘贴
            </button>
