    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 pb-3 border-b border-zinc-100">
          ...
          <div className="flex gap-1.5">
            <Button
              variant="outline"
              size="sm"
              className={`rounded-xl h-8 text-xs gap-1 ${showBankPicker ? "" : "border-zinc-400 text-zinc-700 hover:bg-zinc-50"}`}
        ...
        <div className="flex items-center gap-3 flex-wrap text-xs">
          ...
          <div className="flex items-center gap-1.5 bg-zinc-50 rounded-lg px-2.5 py-1.5 border border-zinc-200/60">
            <Icon name="hourglass_top" size={13} className="text-zinc-500" />
            <span className="text-zinc-600">模考总时间</span>
            <input
              type="number"
              ...
              className="w-10 text-[11px] text-center bg-white border border-zinc-200 rounded px-1 py-0.5 focus:outline-none focus:ring-1 focus:ring-zinc-300"
              min={1}
              step={1}
            />
            <span className="text-zinc-400">分钟</span>
          </div>
        </div>
        ...
        {editingPaper.questions.length === 0 ? (
          <div className="text-center py-10 text-zinc-400">
            <Icon name="playlist_add" size={36} className="mx-auto mb-2 text-zinc-300" />
          ...
          <div className="space-y-2">
            {editingPaper.questions.map((q, i) => (
              ...
              >
                <span className="w-5 h-5 rounded-full bg-zinc-100 text-zinc-700 text-[10px] font-bold flex items-center justify-center shrink-0 mt-0.5">
                  {i + 1}
                </span>
          ...
          <div className="space-y-2 pt-2">
            <div className="flex gap-2 sm:gap-3">
              <Button
                ...
                className="flex-1 bg-zinc-600 hover:bg-zinc-500 text-white rounded-xl h-10 sm:h-11 text-sm shadow-sm gap-1.5 active:scale-[0.98]"
              >
              ...
              <Button
                ...
                className="flex-1 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl h-10 sm:h-11 text-sm shadow-sm gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <Input
          ...
          placeholder="试卷名称（可选）"
          className="h-9 rounded-xl text-sm flex-1 focus-visible:ring-zinc-200"
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="gap-1.5 rounded-xl h-9 text-xs shrink-0 hover:border-zinc-400 hover:text-zinc-700"
        >
      ...
      {papers.length === 0 ? (
        <div className="text-center py-12 text-zinc-400">
          <Icon name="description" size={40} className="mx-auto mb-3 text-zinc-300" />
